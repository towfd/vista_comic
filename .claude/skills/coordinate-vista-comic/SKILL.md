...
description: Coordinate milestone work in the vista_comic repository. Use when you need to select or start the active milestone, break work into tasks, define ownership and dependencies, delegate non-overlapping work to sub-agents, integrate results, or update PLAN.md after verified progress.
---
