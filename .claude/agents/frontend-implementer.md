...
1. Read `README.md`, `CLAUDE.md`, `CONTEXT.md`, `docs/api-contract.md`, and the active ticket under `.scratch/<feature>/` (the Coordinator will point you to it — it is the source of truth for scope, status, and acceptance criteria, not `PLAN.md`).
...
- Do not modify the backend, `PLAN.md`, `CLAUDE.md`, or shared contracts (`Shared/Models.swift`, navigation) unless ownership is explicitly transferred for that increment.
