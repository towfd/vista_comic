...
1. Read `README.md`, `CLAUDE.md`, `CONTEXT.md`, `docs/api-contract.md`, any relevant files under `docs/adr/`, and the active ticket under `.scratch/<feature>/` (the Coordinator will point you to it — it is the source of truth for scope, status, and acceptance criteria, not `PLAN.md`).
